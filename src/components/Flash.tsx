        ...
        <div className='mt-10'>
            ...
            <div className="flex flex-col justify-between col-span-1 md:col-span-2 bg-green-600 mt-10 rounded-lg">
                <h1 className='mb-1 p-3'>
                    Hey there! I'm currently looking for Summer 2025 Internship opportunities, so if you have something cool for me, please <a className='underline hover:text-green-400' href="/contact">let me know!</a>
                </h1>
