            ...
            <div className="mt-10">
                <div className="grid md:grid-cols-2 grid-cols-1 mb-20">
                    <div>
                        ...
                        <p className='text-lg mb-7'>My first ever web app, AurParho aimed to fix a problem that I saw within my high school; inefficient sharing of notes. As such, I built AurParho, so that everyone could access my class notes all in one place.</p>
                        <div className='flex'>
