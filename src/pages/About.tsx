        ...
        <>
            ...
            <div className="grid grid-cols-1 p-6 md:p-10 pb-0 md:grid-cols-2 min-h-screen ">
                <div className="flex justify-center mt-10 flex-col">
                    ...
                    <p className="mb-3">Let's get the boring stuff out of the way first: I'm a <span className="font-bold text-emerald-400">full stack developer</span> with a particular expertise in JavaScript and related technologies. I love working on the front end, back end, and everything in between, and I'm always looking for ways to make my code more efficient, elegant, and effective. I'm also a first-year math undergraduate student at the <span className="font-bold text-yellow-400">University of Waterloo</span>, which keeps me pretty busy most days.</p>
