        ...
        <div className="p-6 md:p-10">
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3 mb-10">
                    ...
                    <a rel="noreferrer" target="_blank" href="https://aurparhobucket.s3.ap-south-1.amazonaws.com/Bassam_Ahmed_resume_ext_v10.pdf" className="rounded-lg hover:bg-slate-400 bg-yellow-400 text-center py-3 px-5">
