...
function Home() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 p-6 md:p-10 min-h-screen px-10 md:px-20">
            <div className="flex flex-col justify-center align-center">
                <h4 className="text-lg">Hello there!</h4>
                
                <h1 className="text-6xl">I&apos;m <strong>Bassam</strong> Ahmed</h1>
                <p className="text-md">A developer by day, and by night... still a developer.</p>
            </div>
